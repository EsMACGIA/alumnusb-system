...
from .views import register, achievements, stats, Profile, friends_ranking, FriendRequests, requesting_me, accept_friend
...
urlpatterns = [
    ...
    path('friend_requests/accept/<username>', accept_friend, name="friend_requests_accept"),
